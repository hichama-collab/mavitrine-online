  ...
  languages: {
    ...
    en: {
      ...
      social: {
        ...
        title: "A coherent online presence",
        text: "The website can be extended with Instagram and Facebook to reinforce your image, highlight updates and make contact easier.",
        instagramTitle: "A visual account aligned with your business",
        instagramPoints: [
          "News, launches or achievements",
          "Identity aligned with the website",
          "Simpler contact"
        ],
        facebookTitle: "A clear and reassuring page",
        facebookPoints: [
          "Contact details and opening hours easy to find",
          "Useful posts",
          "More credible presence"
        ],
      ...
      contact: {
        ...
        actions: [
          ...
          "Previous website or document if available"
        ],
      ...
      footer: {
        navTitle: "Navigation",
        contactTitle: "Contact",
        socialTitle: "Digital touchpoints",
        socials: ["Instagram", "Facebook", "Showroom"],
        legal: "Legal notice"
      }
    }
